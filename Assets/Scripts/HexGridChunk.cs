...
public class HexGridChunk : MonoBehaviour
{
    ...
    void Triangulate(HexDirection direction, HexCell cell) 
    {
        ...
        {
            TriangulateWihtoutRiver(direction, cell, center, e);
    ...
    void TriangulateWihtoutRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
    ...
    void TriangulateRoadAdjacentToRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e)
    {
        ...
        else if (cell.IncomingRiver == cell.OutgoingRiver.Opposite()) // straight river
        {
            Vector3 corner;
            if (previousHasRiver)
            {
        ...
        else if (previousHasRiver && nextHasRiver) // inside of curved river
        {
